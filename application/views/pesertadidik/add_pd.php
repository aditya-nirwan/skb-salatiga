                    ...
                    <form action="" method="post">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="nama" value="<?= set_value('nama') ?>" class="form-control <?= form_error('nama') ? 'is-invalid' : null ?>" id="nama" placeholder="Nama Lengkap">
                                    <?= form_error('nama') ?>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                        <label class="btn bg-light <?= form_error('gender') ? 'btn-outline-danger' : 'btn-outline-light' ?>">
                                            <input type="radio" name="gender" id="option_b1" autocomplete="off" value="L" <?= set_value('gender') == 'L' ? "checked" : null ?>> Laki-laki
                                        </label>
                                        <label class="btn bg-light <?= form_error('gender') ? 'btn-outline-danger' : 'btn-outline-light' ?>">
                                            <input type="radio" name="gender" id="option_b2" autocomplete="off" value="P" <?= set_value('gender') == 'P' ? "checked" : null ?>> Perempuan
                                        </label>
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <textarea name="alamat" class="form-control <?= form_error('alamat') ? 'is-invalid' : null ?>" rows="2" placeholder="Alamat" style="min-height: 50px;"><?= set_value('alamat') ?></textarea>
                                    <?= form_error('alamat') ?>
                                </div>
                            </div>
